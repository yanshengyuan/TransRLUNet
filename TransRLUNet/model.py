...
class LeFF(nn.Module):
    def __init__(self, out_dim, dim=32, hidden_dim=128, act_layer=nn.GELU,drop = 0.):
        super().__init__()
...
class LeWinTransformerBlock(nn.Module):
    def __init__(self, out_dim, dim, input_resolution, num_heads, win_size=8, shift_size=0,
        ...
        self.mlp = Mlp(in_features=dim, hidden_features=mlp_hidden_dim,act_layer=act_layer, drop=drop) if token_mlp=='ffn' else LeFF(out_dim, dim,mlp_hidden_dim,act_layer=act_layer, drop=drop)
...
class BasicUformerLayer(nn.Module):
    def __init__(self,dim, output_dim, input_resolution, depth, num_heads, win_size,
        ...
        self.blocks = nn.ModuleList([
            LeWinTransformerBlock(out_dim=self.out_dim,dim=dim, input_resolution=input_resolution,
...
class Uformer(nn.Module):
    def __init__(self, img_size=128, in_chans=3,
        ...
        # Encoder
        self.feature_fus_0 = BasicUformerLayer(dim=embed_dim*2,
        ...
        self.feature_fus_1 = BasicUformerLayer(dim=embed_dim*4,
        ...
        self.feature_fus_2 = BasicUformerLayer(dim=embed_dim*8,
        ...
        self.feature_fus_3 = BasicUformerLayer(dim=embed_dim*16,
